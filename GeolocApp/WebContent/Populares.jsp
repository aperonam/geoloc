...
<div id="divlogin"><section class="row1">  
 ...
 <div id="simpleModal" class="modal">
    ...
    <button id="actualizar" onClick="sendAjax()"><img id="imgActualizar" src="./assets/img/actualizar.png" alt="actualizar" /></button>
    <a id="populares" href="Populares.jsp"><img id="imgPopulares" src="./assets/img/populares.png" alt="actualizar" /></a>
    <a id="misMarkers" href="MisMarkers.jsp"><img id="imgMarkers" src="./assets/img/Mimarker.png" alt="actualizar" /></a>
    <button id="Tag"><img id="imgTag" src="./assets/img/tag.png" alt="Tag" /></button>
